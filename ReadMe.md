...
An Android app that simply displays Android built-in drawables

## Description

Can be useful for determining what the drawable resource might look like when you use it in your app.
